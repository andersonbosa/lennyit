/* Here are a good place to start :D */
...
chrome.runtime.onInstalled.addListener(async () => {
  ...
  // While we could have used `let url = "popup.html"`, using runtime.getURL is a bit more robust as
  // it returns a full URL rather than just a path that Chrome needs to be resolved contextually at
  // runtime.
  let url = chrome.runtime.getURL('public/pages/popup.html')
